...
class DeviceDependency{
    ...
    static let sharedInstance = DeviceDependency()
    ...
    var barPosition_Y           : CGFloat!
    
    var menuButtonPosition_Y    : CGFloat!
    var petInfoButtonPosition_Y : CGFloat!
    
    var hearCountLabelPosition  : CGPoint!
    var heart_n_coin_LabelScale : CGFloat!
    ...
    private func AlignToPhoneDevice(){
        ...
        case "Simulator iPhone 11":
            ...
            menuButtonPosition_Y    = 70
            petInfoButtonPosition_Y = 70
        ...
        case "Simulator iPhone 11 Pro Max":
            ...
            hearCountLabelPosition  = CGPoint(x: 143, y: 55)
            heart_n_coin_LabelScale = 1
